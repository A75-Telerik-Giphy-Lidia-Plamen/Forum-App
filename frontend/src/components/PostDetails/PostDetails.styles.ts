export const styles = {
  ...
  dateMeta: `
    flex items-center gap-1 text-xs text-stone-400
    dark:text-zinc-500
  `,
  dateIcon: "w-3.5 h-3.5",

  title: `
    text-3xl font-bold text-stone-900 leading-tight mb-6
    dark:text-zinc-100
  `,
  ...
  reputationBar: `
    w-24 h-1.5 rounded-full bg-stone-200 overflow-hidden
    dark:bg-zinc-700
  `,

  reputationFill: `
    h-full rounded-full bg-orange-400
    dark:bg-gradient-to-r dark:from-amber-400 dark:via-orange-500 dark:to-amber-600
  `,

  content: `
    text-sm text-stone-700 leading-relaxed whitespace-pre-wrap mb-6
    dark:text-zinc-300
  `,
  ...
  divider: `
    border-t border-stone-200 mb-4
  ...
  deleteBtn: `
    ...
    dark:border-red-500/40 dark:bg-zinc-900 dark:text-red-400 dark:hover:bg-red-900/20
  `,

  commentsSection: "space-y-4",

  commentsHeading: `
    text-base font-semibold text-stone-900 mb-3
    dark:text-zinc-100
  `,
  ...
  commentTextarea: `
    ...
    dark:text-zinc-300 dark:placeholder:text-zinc-500 dark:bg-transparent
  `,
